...
// Đổi ngày dương lịch ra số Jd (Julian day number)
...
// Đổi số Jd (Julian day number) ra ngày dương lịch
const jdToDate = (jd: any, lunarMonth: number, lunarYear: number) => {
  ...
  if (lunarYear % 2 === 0) {
    ...
    if (lunarMonth < 11) {
      return new Array(day, month + 1, year);
    } else {
      return new Array(day, month, year);
    }
  }
...
const getSunLongitude = (jdn: any, timeZone: any) => {
...
//  Đổi ngày âm lịch ra ngày dương lịch
export const convertLunar2Solar = (
  ...
  return jdToDate(monthStart + lunarDay - 1, lunarMonth, lunarYear);
};
